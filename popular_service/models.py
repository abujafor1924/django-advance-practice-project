...
class Doctor(models.Model):
    ...
    hospital = models.ForeignKey(Hospital, related_name='doctors', on_delete=models.CASCADE, null=True, blank=True)
    subcategories = models.ManyToManyField(SubCategory, related_name='doctors')
