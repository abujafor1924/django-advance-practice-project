...
# Cookies
SESSION_COOKIE_SECURE = config('SESSION_COOKIE_SECURE', default=not TESTING, cast=bool)
CSRF_COOKIE_SECURE = config('CSRF_COOKIE_SECURE', default=not TESTING, cast=bool)
